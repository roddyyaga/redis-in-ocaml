...
If :code:`redis-clone` is available in your opam repository, you can just call::

  opam install redis-clone

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`redis-clone` in a directory.

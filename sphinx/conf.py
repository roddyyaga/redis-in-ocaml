...
# -*- coding: utf-8 -*-
#
# redis-clone documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = 'redis-clone'
copyright = 'Roddy <github@roddymacsween.co.uk>'
author = 'Roddy <github@roddymacsween.co.uk>'
...
latex_documents = [
    (master_doc, 'redis-clone.tex', 'redis-clone Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'redis-clone', 'redis-clone Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'redis-clone', 'redis-clone Documentation',
     author, 'redis-clone', 'One line description of project.',
     'Miscellaneous'),
]
